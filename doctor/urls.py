...
urlpatterns = [
    ...
    path(
        "patient-list/patient/<int:patientId>",
        views.patientRecord,
        name="patientDiagnosis",
    ),
    path(
        "viewPrescription/<int:prescriptionId>",
    ...
    path(
        "laboratoryTest/<int:prescriptionId>",
        views.laboratoryTest,
        name="laboratoryTest",
    ),
    path(
        "viewMedicine/<int:medicineId>/<int:prescriptionId>",
        views.viewMedicine,
        name="viewMedicine",
    ),
]
